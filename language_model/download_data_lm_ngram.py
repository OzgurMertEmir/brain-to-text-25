"""
Run this file to download n-gram models from Dryad and unzip the zip files. Downloaded files end
up in this repostitory's data/ directory.

First create the .venv virtual environment. Then in a Terminal, at this repository's
language_model directory (brain-to-text-25/), run:

source .venv/bin/activate
cd language_model
python download_data_lm_ngram.py
"""
...
TARGET_FILE_NAME = "languageModel_5gram.tar.gz"
########################################################################################
#
# Helpers.
#
...
def main():
    ...
    DATA_DIR = "pretrained_language_models/"
    ...
    ## Download only the languageModel_5gram.tar.gz file.
